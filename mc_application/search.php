        ...
        <div class="flex flex-wrap ">
            ...
            if (have_posts()) {
                while (have_posts()): the_post();
                    ...
                    $image_url = $image_url === "" ? "https://dummyimage.com/720x400" : $image_url;
                    ?>
                    <div class="p-4 md:w-1/3">
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="https://dummyimage.com/720x400" alt="blog">
                            <div class="p-6">
                                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1"><?= __('Title') ?></h2>
                                <h1 class="title-font text-lg font-medium text-gray-900 mb-3"><?= $post->post_title ?></h1>
                                <p class="leading-relaxed mb-3"><?= $abstract ?></p>
