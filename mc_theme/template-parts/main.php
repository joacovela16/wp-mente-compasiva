...
<div class="relative overflow-hidden w-full ">
    ...
    <div style="height: calc(100vh - 88px)" class="relative w-full overflow-hidden ">
        <video class="absolute top-0 left-0 w-full h-full object-cover gradient-animation" x-init="loaderOn=false" src="<?= $url ?>" autoplay muted loop></video>
        <div class="custom-shape-divider-bottom-1637812056 ">
            <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" class="-m-b-10" viewBox="0 0 1200 120" preserveAspectRatio="none">
    ...
    <div class="absolute top-0 left-0 h-full w-full flex items-center justify-center">
        <div class="text-white text-shadow-lg justify-center flex flex-col">
            <div class=" lg:text-7xl text-3xl sm:text-6xl  mx-auto">MENTE COMPASIVA</div>
            <div class="flex flex-row items-center justify-center space-x-0 sm:space-x-3 mt-16 sm:mt-20">
