...
$search_fields = ['tag', 'country', TOOK_CFT, SORTBY, PBEFORE, PAFTER, 's','post_type'];
    ...
    <form class="space-y-2" method="get">
        ...
        <div class="md:mb-0">
            <label class="uppercase text-gray-700 text-xs font-bold mb-2">
                <span><?= __('Search') ?></span>
                <input type="text" class="w-full border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded" name="s" value="<?= $_GET['s']??'' ?>" tabindex="0">
            </label>
        </div>
        ...
        <div class="md:mb-0">
            <label class="uppercase text-gray-700 text-xs font-bold mb-2">
                ...
                <input type="text" class="w-full border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded" name="country">
            </label>
        </div>
        <div class="md:mb-0">
            <label class="uppercase text-gray-700 text-xs font-bold mb-2">
