...
<footer class="bg-zinc-100">
    <div class="container px-5 py-11 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
            © <?= date("Y") ?> Mente Compasiva —
            <a href="https://cultivarlamente.com/" class="text-blue-500 ml-1" rel="noopener noreferrer" target="_blank">
                <span class="italic">Un proyecto de Cultivar la Mente - Salud mental y prácticas contemplativas</span>
            </a>
        </p>
