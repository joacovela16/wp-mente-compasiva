<script>
    import MultiDropdown from "./widgets/base/MultiDropdown.svelte";
    import DropdownItem from "./widgets/base/DropdownItem.svelte";
    ...
    let currentView;
    onMount(() => {
        setTimeout(() => currentView = Main, 500);
    });
</script>
    ...
    <div class="flex flex-col bg-white">
        <div class="flex flex-row p-3 font-bold items-center ">
            ...
            <div class="flex-grow-0 flex flex-row items-center border-b-gray-300 border-b-width-2 bg-white px-2 bg-white">
                ...
                <div class="cursor-pointer hover:underline" on:click={()=>showFilters=!showFilters}>
