...
const Dropdow = {
    ...
    template: `
        <div class="relative inline-block text-left" ref="rootEl">
            <div
                    class="flex flex-row justify-center w-full rounded shadow-sm px-4 py-2 bg-white
                           font-medium hover:bg-gray-50 focus:outline-none cursor-pointer focus:ring-2
                           focus:ring-blue-500"
                    @click="open=!open"
            >
                <div>{{label}}</div>
